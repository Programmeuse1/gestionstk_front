...
class VentesApiService extends __BaseService {
  static readonly findAllPath = '/gestiondestock_backend/v1/ventes/all';
  static readonly savePath = '/gestiondestock_backend/v1/ventes/create';
  static readonly deletePath = '/gestiondestock_backend/v1/ventes/delete/{idVente}';
  static readonly findByCodePath = '/gestiondestock_backend/v1/ventes/{codeVente}';
  static readonly findByIdPath = '/gestiondestock_backend/v1/ventes/{idVente}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<VentesDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock_backend/v1/ventes/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: VentesDto): __Observable<__StrictHttpResponse<VentesDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock_backend/v1/ventes/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idVente: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock_backend/v1/ventes/delete/${encodeURIComponent(String(idVente))}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByCodeResponse(codeVente: string): __Observable<__StrictHttpResponse<VentesDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock_backend/v1/ventes/${encodeURIComponent(String(codeVente))}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(idVente: number): __Observable<__StrictHttpResponse<VentesDto>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock_backend/v1/ventes/${encodeURIComponent(String(idVente))}`,
      __body,
      {
        headers: __headers,
        params: __params,
...
module VentesApiService {
}

export { VentesApiService }
